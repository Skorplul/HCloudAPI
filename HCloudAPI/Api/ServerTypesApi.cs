...
namespace HCloudAPI.Api
{
    ...
    /// </summary>
    public interface IGetServerTypeApiResponse : IApiResponse, IOk<GetServerTypeResponse?>, IHttpStatusCode4XX<GetActions4xxResponse?>, IHttpStatusCode5XX<GetActions5xxResponse?>
    {
        /// <summary>
    ...
    /// </summary>
    public interface IListServerTypesApiResponse : IApiResponse, IOk<ListServerTypesResponse?>, IHttpStatusCode4XX<GetActions4xxResponse?>, IHttpStatusCode5XX<GetActions5xxResponse?>
    {
        /// <summary>
        /// Returns true if the response is 200 Ok
        /// </summary>
    ...
    public sealed partial class ServerTypesApi : IServerTypesApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public ServerTypesApi(ILogger<ServerTypesApi> logger, HttpClient httpClient, JsonSerializerOptionsProvider jsonSerializerOptionsProvider, ServerTypesApiEvents serverTypesApiEvents,
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ? "/server_types/{id}"
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/server_types/{id}");
                    ...
                    {
                        GetServerTypeApiResponse apiResponseLocalVar;

                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                                apiResponseLocalVar = new(Logger, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/server_types/{id}", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class GetServerTypeApiResponse : ApiResponse, IGetServerTypeApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            public GetServerTypeApiResponse(ILogger<ServerTypesApi> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
            ...
            /// </summary>
            /// <returns></returns>
            public GetServerTypeResponse? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<GetServerTypeResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out GetServerTypeResponse? result)
            {
                result = null;
        ...
        public async Task<IListServerTypesApiResponse> ListServerTypesAsync(Option<string> name = default, Option<long> page = default, Option<long> perPage = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    uriBuilderLocalVar.Path = HttpClient.BaseAddress.AbsolutePath == "/"
                        ? "/server_types"
                        : string.Concat(HttpClient.BaseAddress.AbsolutePath.TrimEnd('/'), "/server_types");
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ListServerTypesApiResponse apiResponseLocalVar;

                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                                apiResponseLocalVar = new(Logger, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/server_types", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        /// </summary>
        public partial class ListServerTypesApiResponse : ApiResponse, IListServerTypesApiResponse
        {
            /// <summary>
            /// The logger
            /// </summary>
            ...
            /// <param name="requestedAt"></param>
            /// <param name="jsonSerializerOptions"></param>
            public ListServerTypesApiResponse(ILogger<ServerTypesApi> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
                OnCreated(httpRequestMessage, httpResponseMessage);
            }
            ...
            /// </summary>
            /// <returns></returns>
            public ListServerTypesResponse? Ok()
            {
                // This logic may be modified with the AsModel.mustache template
                return IsOk
                    ? System.Text.Json.JsonSerializer.Deserialize<ListServerTypesResponse>(RawContent, _jsonSerializerOptions)
                    : null;
            }
            ...
            /// <param name="result"></param>
            /// <returns></returns>
            public bool TryOk([NotNullWhen(true)]out ListServerTypesResponse? result)
            {
                result = null;
