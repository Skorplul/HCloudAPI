...
namespace HCloudAPI.Model
{
    ...
    public partial class CertificateStatus : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CertificateStatus(Option<IssuanceEnum?> issuance = default, Option<RenewalEnum?> renewal = default, Option<CertificateStatusError?> error = default)
        {
        ...
        public IssuanceEnum? Issuance { get { return this.IssuanceOption.Value; } set { this.IssuanceOption = new(value); } }
        ...
        public RenewalEnum? Renewal { get { return this.RenewalOption.Value; } set { this.RenewalOption = new(value); } }
        ...
        public CertificateStatusError? Error { get { return this.ErrorOption.Value; } set { this.ErrorOption = new(value); } }
    ...
    /// </summary>
    public partial class CertificateStatusJsonConverter : JsonConverter<CertificateStatus>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CertificateStatusJsonConverter" /> class.
        /// </summary>
        public CertificateStatusJsonConverter()
        {
            OnCreated();
        }
        ...
        public override CertificateStatus Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new CertificateStatus(issuance, renewal, error);
        }
