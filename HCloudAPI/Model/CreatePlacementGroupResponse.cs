...
namespace HCloudAPI.Model
{
    ...
    /// </summary>
    public partial class CreatePlacementGroupResponse : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public CreatePlacementGroupResponse(PlacementGroup placementGroup, Option<ActionNullable?> action = default)
        {
    ...
    /// </summary>
    public partial class CreatePlacementGroupResponseJsonConverter : JsonConverter<CreatePlacementGroupResponse>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePlacementGroupResponseJsonConverter" /> class.
        /// </summary>
        public CreatePlacementGroupResponseJsonConverter()
        {
            OnCreated();
        }
