...
namespace HCloudAPI.Model
{
    ...
    public partial class CreateServerRequest : IValidatableObject
    {
        ...
        /// <param name="location">ID or name of the Location to create the Server in.</param>
        /// <param name="startAfterCreate">This automatically triggers a [Power on a Server-Server Action](#tag/server-actions/poweron_server) after the creation is finished and is returned in the &#x60;next_actions&#x60; response object. (default to true)</param>
        ...
        [JsonConstructor]
        public CreateServerRequest(string name, string serverType, string image, Option<string?> location = default, Option<bool?> startAfterCreate = default, Option<long?> placementGroup = default, Option<List<string>?> sshKeys = default, Option<List<long>?> volumes = default, Option<List<long>?> networks = default, Option<List<CreateServerRequestFirewallsInner>?> firewalls = default, Option<string?> userData = default, Option<Dictionary<string, string>?> labels = default, Option<bool?> automount = default, Option<CreateServerRequestPublicNet?> publicNet = default)
        {
            Name = name;
        ...
        /// </summary>
        /// <value>ID or name of the Location to create the Server in.</value>
        ...
        /// </summary>
        /// <value>This automatically triggers a [Power on a Server-Server Action](#tag/server-actions/poweron_server) after the creation is finished and is returned in the &#x60;next_actions&#x60; response object.</value>
        /* <example>true</example> */
        [JsonPropertyName("start_after_create")]
        public bool? StartAfterCreate { get { return this.StartAfterCreateOption.Value; } set { this.StartAfterCreateOption = new(value); } }
        ...
        public long? PlacementGroup { get { return this.PlacementGroupOption.Value; } set { this.PlacementGroupOption = new(value); } }
        ...
        public List<string>? SshKeys { get { return this.SshKeysOption.Value; } set { this.SshKeysOption = new(value); } }
        ...
        public List<long>? Networks { get { return this.NetworksOption.Value; } set { this.NetworksOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<CreateServerRequestFirewallsInner>?> FirewallsOption { get; private set; }
        ...
        public List<CreateServerRequestFirewallsInner>? Firewalls { get { return this.FirewallsOption.Value; } set { this.FirewallsOption = new(value); } }
...
- [touch, /root/cloud-init-worked]
        ...
        public CreateServerRequestPublicNet? PublicNet { get { return this.PublicNetOption.Value; } set { this.PublicNetOption = new(value); } }
    ...
    /// </summary>
    public partial class CreateServerRequestJsonConverter : JsonConverter<CreateServerRequest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CreateServerRequestJsonConverter" /> class.
        /// </summary>
        public CreateServerRequestJsonConverter()
        {
            OnCreated();
        }
        ...
        public override CreateServerRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<CreateServerRequestFirewallsInner>?> firewalls = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "networks":
                            ...
                            break;
                        case "firewalls":
                            firewalls = new Option<List<CreateServerRequestFirewallsInner>?>(JsonSerializer.Deserialize<List<CreateServerRequestFirewallsInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "user_data":
            ...
            return new CreateServerRequest(name.Value!, serverType.Value!, image.Value!, location, startAfterCreate, placementGroup, sshKeys, volumes, networks, firewalls, userData, labels, automount, publicNet);
        }
