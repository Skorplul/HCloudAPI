...
namespace HCloudAPI.Model
{
    ...
    /// </summary>
    public partial class GetLoadBalancerResponse : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public GetLoadBalancerResponse(ListLoadBalancersResponseLoadBalancersInner loadBalancer)
        {
    ...
    /// </summary>
    public partial class GetLoadBalancer200ResponseJsonConverter : JsonConverter<GetLoadBalancerResponse>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="GetLoadBalancer200ResponseJsonConverter" /> class.
        /// </summary>
        public GetLoadBalancer200ResponseJsonConverter()
        {
            OnCreated();
        }
