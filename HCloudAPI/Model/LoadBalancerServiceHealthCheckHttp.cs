...
namespace HCloudAPI.Model
{
    ...
    /// </summary>
    public partial class LoadBalancerServiceHealthCheckHttpJsonConverter : JsonConverter<LoadBalancerServiceHealthCheckHttp>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="LoadBalancerServiceHealthCheckHttpJsonConverter" /> class.
        /// </summary>
        public LoadBalancerServiceHealthCheckHttpJsonConverter()
        {
            OnCreated();
        }
