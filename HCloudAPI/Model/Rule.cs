...
namespace HCloudAPI.Model
{
    ...
    public partial class Rule : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Rule(DirectionEnum direction, ProtocolEnum protocol, Option<string?> description = default, Option<List<string>?> sourceIps = default, Option<List<string>?> destinationIps = default, Option<string?> port = default)
        {
            Direction = direction;
            Protocol = protocol;
        ...
        public List<string>? SourceIps { get { return this.SourceIpsOption.Value; } set { this.SourceIpsOption = new(value); } }
        ...
        public List<string>? DestinationIps { get { return this.DestinationIpsOption.Value; } set { this.DestinationIpsOption = new(value); } }
        ...
        public string? Port { get { return this.PortOption.Value; } set { this.PortOption = new(value); } }
    ...
    public partial class RuleJsonConverter : JsonConverter<Rule>
    {
        ...
        public override Rule Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (port.IsSet && port.Value == null)
                throw new ArgumentNullException(nameof(port), "Property is not nullable for class Rule.");

            return new Rule(direction.Value!.Value!, protocol.Value!.Value!, description, sourceIps, destinationIps, port);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, Rule rule, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (rule.PortOption.IsSet && rule.Port == null)
                throw new ArgumentNullException(nameof(rule.Port), "Property is required for class Rule.");
