...
namespace HCloudAPI.Model
{
    ...
    public partial class ListVolumesResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ListVolumesResponse(List<ListVolumesResponseVolumesInner> volumes, ListMeta meta)
        {
            Volumes = volumes;
            Meta = meta;
            OnCreated();
        ...
        public List<ListVolumesResponseVolumesInner> Volumes { get; set; }
    ...
    /// </summary>
    public partial class ListVolumes200ResponseJsonConverter : JsonConverter<ListVolumesResponse>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ListVolumes200ResponseJsonConverter" /> class.
        /// </summary>
        public ListVolumes200ResponseJsonConverter()
        {
            OnCreated();
        }
        ...
        public override ListVolumesResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ListVolumesResponseVolumesInner>?> volumes = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "volumes":
                            volumes = new Option<List<ListVolumesResponseVolumesInner>?>(JsonSerializer.Deserialize<List<ListVolumesResponseVolumesInner>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "meta":
            ...
            return new ListVolumesResponse(volumes.Value!, meta.Value!);
        }
