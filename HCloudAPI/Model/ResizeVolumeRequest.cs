...
namespace HCloudAPI.Model
{
    ...
    /// </summary>
    public partial class ResizeVolumeRequestJsonConverter : JsonConverter<ResizeVolumeRequest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ResizeVolumeRequestJsonConverter" /> class.
        /// </summary>
        public ResizeVolumeRequestJsonConverter()
        {
            OnCreated();
        }
