...
namespace HCloudAPI.Model
{
    ...
    public partial class CreatePrimaryIPResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CreatePrimaryIPResponse(PrimaryIP primaryIp, Option<ActionNullable?> action = default)
        {
            PrimaryIp = primaryIp;
            ActionOption = action;
            OnCreated();
    ...
    /// </summary>
    public partial class CreatePrimaryIPResponseJsonConverter : JsonConverter<CreatePrimaryIPResponse>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CreatePrimaryIPResponseJsonConverter" /> class.
        /// </summary>
        public CreatePrimaryIPResponseJsonConverter()
        {
            OnCreated();
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, CreatePrimaryIPResponse createPrimaryIPResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (createPrimaryIPResponse.ActionOption.IsSet)
                if (createPrimaryIPResponse.ActionOption.Value != null)
                {
