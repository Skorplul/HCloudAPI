...
namespace HCloudAPI.Model
{
    ...
    public partial class LoadBalancerAlgorithm : IValidatableObject
    {
        ...
        [JsonConstructor]
        public LoadBalancerAlgorithm(TypeEnum type)
        {
            Type = type;
            OnCreated();
        }
    ...
    /// </summary>
    public partial class LoadBalancerAlgorithmJsonConverter : JsonConverter<LoadBalancerAlgorithm>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="LoadBalancerAlgorithmJsonConverter" /> class.
        /// </summary>
        public LoadBalancerAlgorithmJsonConverter()
        {
            OnCreated();
        }
