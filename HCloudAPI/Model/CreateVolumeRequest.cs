...
namespace HCloudAPI.Model
{
    ...
    public partial class CreateVolumeRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public CreateVolumeRequest(int size, string name, Option<Dictionary<string, string>?> labels = default, Option<bool?> automount = default, Option<string?> format = default, Option<string?> location = default, Option<long?> server = default)
        {
            Size = size;
            Name = name;
            LabelsOption = labels;
    ...
    /// </summary>
    public partial class CreateVolumeRequestJsonConverter : JsonConverter<CreateVolumeRequest>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="CreateVolumeRequestJsonConverter" /> class.
        /// </summary>
        public CreateVolumeRequestJsonConverter()
        {
            OnCreated();
        }
        ...
        public override CreateVolumeRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new CreateVolumeRequest(size.Value!.Value!, name.Value!, labels, automount, format, location, server);
        }
