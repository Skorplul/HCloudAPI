...
namespace HCloudAPI.Model
{
    ...
    /// </summary>
    public partial class ServerPublicNetFirewallJsonConverter : JsonConverter<ServerPublicNetFirewall>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ServerPublicNetFirewallJsonConverter" /> class.
        /// </summary>
        public ServerPublicNetFirewallJsonConverter()
        {
            OnCreated();
        }
