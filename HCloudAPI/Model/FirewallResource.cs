...
namespace HCloudAPI.Model
{
    ...
    public partial class FirewallResource : IValidatableObject
    {
        ...
        [JsonConstructor]
        public FirewallResource(TypeEnum type, Option<FirewallResourceServer?> server = default, Option<FirewallResponseAppliedToInnerLabelSelector?> labelSelector = default)
        {
            Type = type;
            ServerOption = server;
        ...
        public Option<FirewallResourceServer?> ServerOption { get; private set; }

        /// <summary>
        /// Gets or Sets Server
        /// </summary>
        [JsonPropertyName("server")]
        public FirewallResourceServer? Server { get { return this.ServerOption.Value; } set { this.ServerOption = new(value); } }
    ...
    /// </summary>
    public partial class FirewallResourceJsonConverter : JsonConverter<FirewallResource>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="FirewallResourceJsonConverter" /> class.
        /// </summary>
        public FirewallResourceJsonConverter()
        {
            OnCreated();
        }
        ...
        public override FirewallResource Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<FirewallResourceServer?> server = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "type":
                            ...
                            break;
                        case "server":
                            server = new Option<FirewallResourceServer?>(JsonSerializer.Deserialize<FirewallResourceServer>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "label_selector":
            ...
            return new FirewallResource(type.Value!.Value!, server, labelSelector);
        }
